...
Feature: Edit accesses
  ...
  Scenario: Edit an access
    ...
    And I send a "PUT" request to "/accesses/33bb0f56-d7f9-49ef-af4f-9ea5a71adf67" with body:
    """
    {
      "owner": "System",
  ...
  Scenario: Edit an access's read-only properties
    ...
    And the JSON node "uuid" should be equal to the string "33bb0f56-d7f9-49ef-af4f-9ea5a71adf67"
